const onlineServices = [
  { link: "https://outlook.office.com/mail/", title: "PUP Webmail" },
  { link: "https://www.pup.edu.ph/iapply/", title: "PUP iApply" },
  { link: "https://sis8.pup.edu.ph/", title: "SIS for Students" },
  { link: "https://sisfaculty.pup.edu.ph/", title: "SIS for Faculty" },
];

const downloads = [
  { link: "https://www.pup.edu.ph/downloads/students/", title: "For Students" },
  {
    link: "https://www.pup.edu.ph/downloads/employees/",
    title: "For Faculty and Employees",
  },
];

const quickLinks = [
  { link: "https://www.pup.edu.ph/about/", title: "About PUP" },
  { link: "https://www.pup.edu.ph/admission/", title: "Admission Information" },
  {
    link: "https://www.pup.edu.ph/about/branchescampuses",
    title: "Branches and Campuses",
  },
  {
    link: "https://www.pup.edu.ph/academic/undergrad",
    title: "Academic Programs",
  },
  {
    link: "https://www.pup.edu.ph/goodgovernance/transparency/2023/",
    title: "Transparency Seals",
  },
  {
  ...
  {
    link: "https://www.pup.edu.ph/international/",
    title: "International Affairs",
  },
  { link: "https://www.pup.edu.ph/jobpost/", title: "Jobs for PUPians" },
];

const socialIcons = [
  {
    link: "https://www.facebook.com/ThePUPOfficial",
    class: "hover:bg-blue-800",
    d: "M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z",
    className: "h-7 w-7",
  },
  {
    link: "https://twitter.com/ThePUPOfficial",
    class: "hover:bg-blue-400",
    d: "M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z",
    className: "h-7 w-7",
  },
  {
    link: "https://www.youtube.com/user/pupcreatv",
    class: "hover:bg-red-400",
    d: "M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z",
    className: "h-7 w-7",
  },
  {
    link: "https://www.linkedin.com/school/polytechnic-university-of-the-philippines/",
    class: "hover:bg-blue-200",
    d: "M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.968v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0v8.399h4.988v-10.131c0-7.88-8.922-7.593-11.018-3.714v-2.155z",
    className: "h-7 w-7",
  },
  {
    link: "https://www.pup.edu.ph/rss/",
  ...
  {
    link: "https://open.spotify.com/show/6x7hlv9qZX8VpwMIRAAiRb?si=h7yM8PeXR6qxSjQIs2GveA&dl_branch=1&nd=1",
...
const pupWebsite = [
  { link: "https://www.pup.edu.ph/terms/", title: "Terms of Use" },
  { link: "https://www.pup.edu.ph/privacy/", title: "Privacy Statement" },
  { link: "https://www.pup.edu.ph/website/", title: "About PUPWebsite" },
];
        ...
        <div className="footer-links">
          ...
          <ul className="quick-links">
            {onlineServices.map((onlineService, index) => (
              <li key={index}>
                <a href={onlineService.link}>{onlineService.title}</a>
              </li>
            ))}
          </ul>
          ...
          <ul className="quick-links">
            {downloads.map((download, index) => (
              <li key={index}>
                <a href={download.link}>{download.title}</a>
              </li>
            ))}
          </ul>
        </div>
              ...
              {socialIcons.map((socialIcon, index) => (
                <li key={index}>
                  <a
                    ...
                    className={`social-icons ${socialIcon.class}`}
                  >
                    <svg
          ...
          <div className="flex flex-col flex-wrap">
            ...
            <ul className="flex inline weblinks">
              {pupWebsite.map((pupWeb, index) => (
                <li key={index}>
                  <a href={pupWeb.link}>{pupWeb.title}</a>
                  {index < pupWebsite.length - 1 ? (
                    <span
                      className="text-3xl md:text-sm"
